...
//        discountModelIs.setFinalPrice(432);
//        discountModelIs.setQuantity(1);
        ...
        for (int i = 0; i < billProductsList.size(); i++) {
            BillProduct billProduct = ( billProductsList.get(i));
...
/*BillSummaryActivityNew extends AppCompatActivity implements Runnable{

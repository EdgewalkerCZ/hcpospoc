...
//                holderSeletedItem.tv_customer_name.setText(KeyValue.getString(context,KeyValue.NAME));
                SpannableStringBuilder mobileStr = appendString("", KeyValue.getString(context, KeyValue.PHONE));
                SpannableStringBuilder emailStr = appendString("", KeyValue.getString(context, KeyValue.EMAIL));

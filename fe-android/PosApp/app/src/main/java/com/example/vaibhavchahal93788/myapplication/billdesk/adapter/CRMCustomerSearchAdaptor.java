...
//            ButterKnife.bind(this, itemView);
        ...
        public void bind(final DataItem model,
            ...
            mCustomerName.setText(model.getFullName());
            mCustomeremail.setText(model.getEmail());
            mCustomerphone.setText(model.getPhone());

//            mCustomerImage.setText(model.getFullName());

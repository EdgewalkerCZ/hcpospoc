...
az container create --resource-group HCIN --name hcin-hcpospoc --image hcpospoc.azurecr.io/hcpospoc:test --cpu 1 --memory 1 --registry-login-server hcpospoc.azurecr.io --registry-username hcpospoc --registry-password $acr_password --dns-name-label hcinhcpospoc --ports 80 8080 8081
